                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown px-md-2 my-2 my-md-0 active-now">
                            ...
                            <div class="dropdown-menu nav-dropdown-menu" aria-labelledby="productDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="structured_products.html">Structured Products</a>
                                <div class="dropdown-divider"></div>
        ...
        <div class="section-1-structured">
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-6">
                        <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Structured Products</h2>
                        <p class="font-weight-light text-white text-center font-17">We offer a profitable investment plan with well-structured products that suit our clients’ lifestyle</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row py-5 justify-content-center text-center">
                    <div class="col-md-8 my-2">
                        ...
                        <p class="">We provide investors with the opportunity to invest in diversified, high yield, carefully selected corporate and government issued asset classes  designed to facilitate highly customized risk-return objectives.</p>

                        <p>Our structured products are managed by our risk and investment management experts embedded and operating in our day-to-day investment activities.</p>
                    </div>
                </div>
            ...
            <div class="row my-5">
                ...
                <div class="col-md-5 offset-md-1">
                    <ul class="">
                        ...
                        <li class="custom-list my-3">Diversified pool of investment, thereby reducing issuer and concentration risks</li>
