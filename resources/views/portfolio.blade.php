...
<html lang="">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown px-md-2 my-2 my-md-0 active-now">
                            ...
                            <div class="dropdown-menu nav-dropdown-menu" aria-labelledby="productDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="portfolio.html">Portfolio Management</a>
                                <div class="dropdown-divider"></div>
        ...
        <div class="section-1-portfolio">
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-6">
                        <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Portfolio Management</h2>
                        <p class="font-weight-light text-white text-center font-17">With our team of professionals, we offer a well-tailored financial services to meet our clients’ investment aspirations.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row py-5">
                    ...
                    <div class="col-md-6 offset-md-1 my-2 text-justify">
                        <p class="">Portfolio Management is about determining strengths, weaknesses, opportunities and threats in the choice of debt versus equity, growth versus safety, domestic versus international and other tradeoffs in the attempt to maximize return at a given risk appetite.
                        </p>

                        <p>At Anchoria Asset Management Limited, we provide customized investment solutions tailored to clients’ specific financial objectives. We manage the fund by investing in a range of financial instruments ranging from traditional asset classes to structed financial instruments in line with clients’ investment policy. Supported by our deep understanding of the local market, our team of investment professionals identify investment solutions with competitive returns, balancing risk against performance to match clients’ risk appetite. We augment these services with robust execution capabilities.</p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row my-5">
                <div class="col-md-8">
                    <h4 class="font-weight-bold mb-3 purple-text-default">Our portfolio management services are classified into:</h4>
                </div>
            </div>
                    ...
                    <div>
                        <ul>
                            ...
                            <li class="custom-list my-3"><span class="font-weight-700">Non-discretionary </span> <br />
                                under this service, the portfolio manager provides guidance on various investment options. The choice as well as the timings of the investment decisions rest solely with the investor. However, the execution of the trade is done by the portfolio manager.</li>
            ...
            <div class="container">
                ...
                <div class="row py-5 justify-content-center text-center">
                    <div class="col-md-8 my-2">
                        <p>Our investment strategy is focused on generating competitive returns through carefully selected investment solutions and investment in strategic asset allocation based on investor’s risk profile. Maximizing investors invested returns for a given level of risk. Strategic asset allocation where the portfolio mix is fix according to the investor’s profile.</p>
