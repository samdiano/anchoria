...
<body>
    ...
    <div class="section-1-home">
        <div class="container">
            <div class="row justify-content-center pb-4 pt-5">
                <div class="col-md-6">
                    <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Mutual Funds
                    </h2>
    ...
    <div class="">
                    ...
                    <div class="purple-card-section d-md-none d-lg-none">
                        <div class="row my-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="text-white mb-0 text-center"><span
                                        class="text-purple-light text-uppercase">BID PRICE</span></p>
                                <p class="text-white mb-0 text-center">5.2</p>
                                <p class="text-white mb-0 text-center"><span
                                        class="text-purple-light text-uppercase">Offer Price</span></p>
                                <p class="text-center my-1"><span
                                        class="bg-white-card text-purple-default px-2">0.5</span></p>
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="text-white mb-0 text-center"><span
                                        class="text-purple-light text-uppercase">Offer Price</span></p>
                                <p class="text-center my-1"><span
                                        class="bg-white-card text-purple-default px-2">1.5</span></p>
                                <hr class="bg-default-purple my-2" />
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="text-white mb-0 text-center"><span
                                        class="text-purple-light text-uppercase">Offer Price</span></p>
                                <p class="text-center my-1"><span
                                        class="bg-white-card text-purple-default px-2">0.9</span></p>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <ul class="nav nav-tabs displace-mutual-tab nav-justified md-tabs mb-3 mt-3 mutual-margin text-center"
                        id="blogTab" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link active small-md border-right-red" id="if-tab-just" data-toggle="tab"
                                href="#if-just" role="tab" aria-controls="if-just" aria-selected="true">Anchoria Fixed
                                Income Fund
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link small-md border-right-red" id="ef-tab-just" data-toggle="tab"
                                href="#ef-just" role="tab" aria-controls="ef-just" aria-selected="true">Anchoria Equity
                                Fund
                                <div class="active-bob mt-1"></div>
                            </a>
                            <hr class="d-md-none" />
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link small-md" id="market-tab-just" data-toggle="tab" href="#market-just"
                                role="tab" aria-controls="market-just" aria-selected="true">Anchoria Money Market Fund
                                <div class="active-bob mt-1"></div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContentJust">
                        ...
                        <div class="tab-pane fade show active" id="if-just" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 my-2">
                                    <h6 class="font-weight-600 text-uppercase text-grey">Anchoria Fixed Income Fund :
                                    </h6>
                                    <h6 class="font-weight-600 text-uppercase text-grey">Achieving your Medium to Long
                                        term goals</h6>
                                    ...
                                    <h6 class="font-weight-600 text-uppercase text-grey mb-4">Fix your future today by
                                        investing in the Anchoria Fixed Income Fund.</h6>
                        ...
                        <div class="tab-pane fade" id="ef-just" role="tabpanel" aria-labelledby="ef-tab-just">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <h6 class="font-weight-600 text-uppercase text-grey">Achieving your Long term goals
                                    </h6>
                                    ...
                                    <h6 class="font-weight-600 text-uppercase text-grey mb-4">Fix your future today by
                                        investing in the Anchoria Equity Fund.
                                    </h6>
                        ...
                        <div class="tab-pane fade" id="market-just" role="tabpanel" aria-labelledby="market-tab-just">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 my-2">
                                    <h6 class="font-weight-600 text-uppercase text-grey">Anchoria Money Market Fund :
                                    </h6>
                                    ...
                                    <h6 class="font-weight-600 text-uppercase text-grey mb-4">Fix your future today!
                                        Invest in the Anchoria Money Market Fund to experience higher returns than you
                                        get when operating a regular savings account.</h6>
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <p class="text-center text-md-left text-dark grey-text my-3 spacing-2 font-weight-bold"> Contact
                            Us</p>
                    ...
                    <div class="offset-md-1 col-md-3 col-lg-3">
                        <p class="text-center text-md-left text-dark font-weight-bold grey-text my-3 spacing-2"> Quick
                            Links</p>

                        <ul class="list-unstyled">
                            <li class="text_primary mb-2"><a href="who.html" class="text-dark">Who We Are</a></li>
                            <li class="text_primary mb-2"><a href="leadership.html" class="text-dark">Leadership</a>
                            </li>

                            <li class="text_primary mb-2"><a href="portfolio.html" class="text-dark">Portfolio
                                    Management</a></li>
                            <li class="text_primary mb-2"><a href="multifamily.html" class="text-dark">Multi-family
                                    Office</a></li>
                            <li class="text_primary mb-2"><a href="account_opening.html" class="text-dark">Open An
                                    Account</a></li>
                            <li class="text_primary mb-2"><a href="uploads/Anchoria%20Corporate%20Profile.pdf"
                                    class="text-dark">Corporate Information</a></li>
                            <li class="text_primary mb-2"><a href="mutual_funds.html" class="text-dark">Mutual Funds</a>
                            </li>
                        </ul>
                    ...
                    <div class="offset-md-1 col-md-3 col-lg-3">
                        <p class="text-center text-md-left text-dark font-weight-bold grey-text my-3 spacing-2">Research
                        </p>
