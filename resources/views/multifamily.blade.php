...
<html lang="">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown px-md-2 my-2 my-md-0 active-now">
                            ...
                            <div class="dropdown-menu nav-dropdown-menu" aria-labelledby="productDropdown">
                                <a class="dropdown-item text-danger" href="multifamily.html">Multi-Family Office</a>
                                <div class="dropdown-divider"></div>
        ...
        <div class="section-1-multifam">
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-6">
                        <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Multi-Family Office</h2>
                        <p class="font-weight-light text-white text-center font-17">Family wealth & legacy are managed with dedication & expertise.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row py-5">
                    ...
                    <div class="col-md-5 offset-md-1">
                        <p>Our multi-family office supports families with the management, organisation and maintenance of their wealth.</p>

                        <p>Our multi-family office supports families with a wide range of services, bespoke wealth and investment management strategies to safeguard and increase their wealth. We are dedicated to helping our clients build, nurture and sustain wealth with ease. We act as the custodians of investment information, providing clients with a consolidated report on their investments with various institutions.</p>
                    </div>
                </div>
