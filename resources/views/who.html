    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown px-md-2 my-2 my-md-0 active-now">
                            ...
                            <div class="dropdown-menu nav-dropdown-menu" aria-labelledby="aboutDropdown">
                                <a class="dropdown-item text-danger" href="who.html">Who We Are</a>
        ...
        <div class="section-1-who">
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-7">
                        <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Who We Are</h2>
                        <p class="font-weight-light text-white font-17 text-center">We are an institution focused on partnering with our clients to achieve their life’s goal through financial intermediation. We currently service a broad spectrum of clients ranging from individuals to large corporates</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section-2-home">
            ...
            <div class="container">
                <div class="row justify-content-center mt-md-5 pb-5">
                    ...
                    <div class="col-md-6 text-justify">
                        ...
                        <p class="font-14">Anchoria Asset Management (AAM) is a specialist provider of active investment products and services to institutional and individual investors. Our investment products focus on capital preservation while providing income and asset class diversification. We leverage the experience and financial strength of our core investors, VFD Group and Anchoria Investment & Securities, market position and intelligence of Nigerian financial, forex & real asset markets. This allows us focus on our clients’ best interests to build upon solid investment and risk management processes.
                        </p>

                        <p class="font-14">Grown out of Anchoria Investments & Securities, which was established in Nigeria In 1994, Anchoria Asset Management has built upon their legacy with innovative investment capabilities.</p>

                        <p class="font-14">Anchoria Asset Management is incorporated by the Corporate Affairs Commission (CAC) as a Funds/Portfolio Manager and is licensed with the Securities and Exchange Commission (SEC).</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container position-relative">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="green-card-section px-3 pt-4 pb-3">
                            <div class="row mt-2 justify-content-center">
                                <div class="col-md-10 mt-4">
                                    ...
                                    <p class="font-16 font-weight-bold text-green-deep">
                                        To become our clients’ most valuable asset by providing them with relevant wealth management solutions with the goal of their financial well-being.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="section-2-home">
            <div class="container">
                <div class="row justify-content-center py-4">
                    <div class="col-md-8">
                        <h2 class="purple-text-default font-weight-bold text-center">Core Values</h2>
                    </div>
                </div>
                <div class="row justify-content-center mt-1">
                    <div class="col-md-4 my-4">
                        ...
                        <p class="font-14 text-dark ml-md-3">
                            We ensure that our goals are aligned with our clients, and our people are held to the highest ethical standards and moral character.
                        </p>
                    </div>
                ...
                <div class="row justify-content-center mt-1">
                    <div class="col-md-4 my-4">
                        ...
                        <p class="font-14 text-dark ml-md-3">
                            Our people deliver thought leadership, community engagement and innovative services through technology and modern practices.
                        </p>
                    </div>
