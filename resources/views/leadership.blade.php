...
<body>
		...
		<div class="row justify-content-center mt-5">
			...
			<div class="col-md-6 py-3">
				<div class="row" data-toggle="modal" data-target="#ete">
					...
					<div class="col-md-6">
						<h6 class="hover-cursor font-weight-bold mt-1 text-md-left text-center purple-text-default">ETE
							OGUN</h6>
		...
		{{-- <div class="row justify-content-center hover-cursor">
			<div class="col-md-5 py-3">
				<div class="row" data-toggle="modal" data-target="#adaobi">
					<div class="col-md-5">
						<div class="hover-cursor leadership_shot"
							style="background-image: url(img/board/AdaobiEkweanya.jpg);">
						</div>
					</div>

					<div class="col-md-6">
						<h6 class="hover-cursor font-weight-bold mt-1 text-md-left text-center purple-text-default">
							ADAOBI EKWEANYA</h6>
			...
			<div class="col-md-5 py-3">
				<div class="row" data-toggle="modal" data-target="#nonso">
					<div class="col-md-5">
						<div class="hover-cursor leadership_shot"
							style="background-image: url(img/board/BabatundeDada.jpg)">
						</div>
					</div>
		...
		{{-- <div class="row justify-content-center">
			<div class="col-md-5 py-3">
				<div class="row" data-toggle="modal" data-target="#abayomi">
					<div class="col-md-5">
						<div class="hover-cursor leadership_shot"
							style="background-image: url(img/board/abayomiawobokun.jpg);">
						</div>
					</div>
			...
			<div class="col-md-5 py-3">
				<div class="row" data-toggle="modal" data-target="#kelvin">
					<div class="col-md-5">
						<div class="hover-cursor leadership_shot"
							style="background-image: url(img/board/KelvinOrogun.JPG);">
						</div>
					</div>

					<div class="col-md-6">
						<h6 class="hover-cursor font-weight-bold mt-3 text-md-left text-center purple-text-default">
							KELVIN OROGUN</h6>
						<p class="text-md-left text-center">Director</p>
					</div>
				</div>
		...
		{{-- <div class="row">
			<div class="col-md-5 py-3 offset-md-1">
				<div class="row" data-toggle="modal" data-target="#bolaji">
					<div class="col-md-5">
						<div class="hover-cursor leadership_shot"
							style="background-image: url(img/board/BolajiAdewumi.jpg)">
						</div>
					</div>
		...
		<div class="modal-dialog modal-dialog-centered leadership_modal" role="document">
			<div class="modal-content">
				<div class="modal-header border-0 pb-0">
					<img src="img/close_button.png" alt="close button" class="img-fluid position-absolute close_button"
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Adeniyi Adenubi is the Executive Director of Institutional Business &
								Investor Relations, VFD Group Plc.
							</p>

							<p class="font-13">A Financier and an investor with about fifteen (15) years of experience
								in the Institutional banking, Investment management and consulting sectors.</p>

							<p class="font-13">He holds a degree in Sociology from the University of Ibadan. He has
								certifications in Finance and Business Management from the Tanaka Business School.</p>

							<p class="font-13">Niyi vast experience in the financial sector comes from working in
								Private equity, Venture Capital, and Financial Advisory.<br />
								He has played Financial Advisory roles to numerous firms in Nigeria and in the United
								Kingdom, most notably with the Royal Bank of Scotland and ATOS Consulting.</p>

							<p class="font-13">He is the Chairman of Anchoria Asset Management and also serves on the
								Boards of several companies including VFD MFB, Kairos Capital, Everdon Bureau de Change
								and Premium Green where he works on providing strategic direction for the needs of
								companies he is directly involved with to operate at full potential and efficiency.</p>

							<p class="font-13">Niyi is also currently a Managing Partner and Cofounder of Paragon
								Partners.
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Adaobi Ekweanya is a Director at Anchoria Asset Management Limited. Her
								experience spans across various divisions including asset management, corporate finance
								and business development. Prior to her appointment, she was the Head of Business
								Development of FSDH Asset Management Limited.</p>

							<p class="font-13">Adaobi has over 12 years investment banking and capital market experience
								working in top firms in the financial services industry like Futureview Financial
								Services, Vetiva Capital Management Limited, FSDH Asset Management Limited and Ascendo
								Consulting Limited in London. Adaobi is a member of the Association of Chartered
								Certified Accountants (ACCA) and hold a B.Sc. in Accounting from the prestigious
	...
	<div class="modal fade" id="nonso" tabindex="-1" role="dialog" aria-labelledby="exec_infoLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered leadership_modal" role="document">
			<div class="modal-content">
				<div class="modal-header border-0 pb-0">
					<img src="img/close_button.png" alt="close button" class="img-fluid position-absolute close_button"
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Babatunde Dada is a Non-Executive Director at Anchoria Asset Management
								Limited. He is also the Managing Director/CEO of Anchoria Investment and Securities
								Limited. He was at previous times, CEO of Anchoria Asset Management Ltd and Executive
								Director of Anchoria Investment & Securities Ltd.
							</p>

							<p class="font-13">Babatunde is an Associate Member of the Chartered Institute of
								Stockbrokers, Nigeria, an Associate Member of the Chartered Institute of Securities and
								Investment (CISI), UK and an ISEB certified consultant. He spent 7 years working as a
								Quality Assurance Consultant in various organizations in the UK, most recently the
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Abayomi Awobokun is a Non-Executive director at Anchoria Asset Management
								Limited. With over thirteen years’ experience in the Oil & gas industry. Abayomi has a
								great deal of financial acumen with expertise in Risk management, Corporate Governance,
								Entrepreneurship, Organization development & Human Resource, Divestments, Mergers &
								Acquisition management.
							</p>

							<p class="font-13">He spent eight years at Oando PLC, moving positions from Head of Investor
								Relations, to COO and then CEO of Oando Marketing PLC, and finally, Divisional CEO
								(International Trading & Marketing Company).
							</p>

							<p class="font-13">Abayomi holds a B.Sc. in Pure & Applied Mathematics and an MSc in
								International Business Management. He is a member of the Institute of Directors and the
								founder of “The September 20 Foundation” (TS20F). He was nominated for Young Global
								Leader (YGL)at the World Economic Forum in 2016 and the Arch Bishop Desmond Tutu (Tutu
								Fellow) in 2017.
							</p>
	...
	<div class="modal fade" id="kelvin" tabindex="-1" role="dialog" aria-labelledby="exec_infoLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered leadership_modal" role="document">
			<div class="modal-content">
				<div class="modal-header border-0 pb-0">
					<img src="img/close_button.png" alt="close button" class="img-fluid position-absolute close_button"
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Kelvin Orogun is a Non-Executive Director at Anchoria Asset Management
								Limited. He is also the Managing Director and Chief Executive Officer of Cashpot
								Limited. Cashpot Limited is a money remittance company with headquarters in London and
								offices in Lagos Nigeria. Prior to starting Cashpot, he was the Managing Director,
								Africa Market- Small world financial services Group Ltd from October 2006 to December
								2010. He started his career in Universal Trust Bank.
							</p>

							<p class="font-13">Kelvin is a graduate of University of Benin where he obtained a
								Bachelor’s degree in Computer Science. He also obtained an MBA from Cass Business
	...
	<div class="modal fade" id="bolaji" tabindex="-1" role="dialog" aria-labelledby="exec_infoLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered leadership_modal" role="document">
			<div class="modal-content">
				<div class="modal-header border-0 pb-0">
					<img src="img/close_button.png" alt="close button" class="img-fluid position-absolute close_button"
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<p class="font-13">Mobolaji Adewumi is a Non-Executive Director at Anchoria Asset Management
								Limited. He is currently the Executive Director, Finance for VFD Group Plc. He was the
								Special Assistant to the MD of First Bank of Nigeria Limited.</p>

							<p class="font-13">Prior to joining FirstBank, he was the Special Adviser to the MD of ASO
								Savings and Loans PLC, the biggest mortgage Bank in Nigeria. He was previously the Head
								of Finance and Performance Management for the Africa Division of United Bank of Africa;
								where he was responsible for coordinating the Finance operation of the Bank in over 19
								African countries (excluding Nigeria). He joined UBA after spending three years in the
								Audit and Risk Advisory Division of KPMG Nigeria. His work experience also includes six
								years’ service in the Nigerian Army.</p>

							<p class="font-13">Mobolaji is a Co-Founder of PremiumGreen Group. PremiumGreen owns
								significant stake in entities such as VFD Group, Dynasty Real Estate and Germaine
								Automobile.</p>
