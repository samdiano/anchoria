...
<html lang="">
    ...
    <body>
        ...
        <div class="section-1-home">
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-6">
                        <h2 class="text-white gotham-bold font-weight-bld text-center mt-5 pt-5 mb-4 font-40">Open an Account with Us</h2>
                        <p class="font-weight-light text-white text-center font-17">Take the first step to building a secured future.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row pb-4 mt-md-5">
                <div class="col-md-4 my-3">
                    <div class="account-border-card">
                        <div class="account-opening-bg">
                            <p class="text-center font-18 text-white">Account Opening <br />Forms</p>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <p class="font-weight-500 p-md-3 p-2 mb-0 purple-text-default"><a href="#" class="purple-text-default"><img src="img/download.png" class="mr-md-3 mr-2 img-fluid" alt="download" /> Download</a></p>
                            </div>
                            <div class="col-6">
                                <p class="font-weight-500 p-md-3 mb-0 p-2"><a href="#" class="purple-text-default"><img src="img/globe.png" class="mr-md-3 mr-1 img-fluid" alt="dowwebnload" /> Apply Online</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 my-3">
                    <div class="account-border-card">
                        <div class="account-opening-bg">
                            <p class="text-center font-18 text-white">Individual & Joint Account Opening Forms</p>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <p class="font-weight-500 p-md-3 p-2 mb-0 purple-text-default"><a href="#" class="purple-text-default"><img src="img/download.png" class="mr-md-3 mr-2 img-fluid" alt="download" /> Download</a></p>
                ...
                <div class="col-md-4 my-3">
                    <div class="account-border-card">
                        <div class="account-opening-bg">
                            <p class="text-center font-18 text-white">Corporate Account Opening Forms</p>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <p class="font-weight-500 p-md-3 p-2 mb-0 purple-text-default"><a href="#" class="purple-text-default"><img src="img/download.png" class="mr-md-3 mr-2 img-fluid" alt="download" /> Download</a></p>
                ...
                <div class="col-md-4 my-3">
                    <div class="account-border-card">
                        <div class="account-opening-bg">
                            <p class="text-center font-18 text-white">Account Opening <br /> Mandate</p><br />
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <p class="font-weight-500 p-md-3 p-2 mb-0 purple-text-default"><a href="#" class="purple-text-default"><img src="img/download.png" class="mr-md-3 mr-2 img-fluid" alt="download" /> Download</a></p>
