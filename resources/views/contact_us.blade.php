                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form class="px-5 pb-5">
                                        ...
                                        <button class="btn vfd-btn-red py-2 px-5 weight-semi-bold rounded mx-md-0 waves-effect waves-light">Send</button>
                                ...
                                <div class="offset-md-1 col-md-5">
                                    <div class="px-5">
                                        ...
                                        <ul class="list-unstyled mb-1">
                                            <li class="text_primary"><img src="img/location.svg" class="img-fluid mr-1" width="12">5th Floor, Elephant House,<br>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="text_primary mb-3"><a href="tel:+2348188899455"><img src="img/call.svg" class="img-fluid mr-1" width="12">+234 818 889 9455</a></li>

                                            <li class="text_primary"><a href="tel:+234 9087284135"><img src="img/call.svg" class="img-fluid mr-1" width="12">+234 908 728 4135</a></li>
                                        </ul>

                                        <ul class="list-unstyled">
                                            <li class="text_primary mb-3"><a href="mailto:info@anchoriaam.com"><img src="img/mail.svg" class="img-fluid mr-1" width="12">info@anchoriaam.com</a></li>


                                            <li class="text_primary mb-3"><a href="mailto:mutualfunds@anchoriaam.com"><img src="img/mail.svg" class="img-fluid mr-1" width="12">mutualfunds@anchoriaam.com</a></li>


                                            <li class="text_primary mb-3"><a href="mailto:clientExperience@anchoriaam.com"><img src="img/mail.svg" class="img-fluid mr-1" width="12">clientExperience@anchoriaam.com</a></li>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 my-5 text-center">
                        <p class="text-uppercase text-white text-center font-18">Let’s put your money to work. Start investing today.</p>
                        <a href="account_opening.html" class="btn vfd-btn-red py-2 px-5 weight-semi-bold rounded mx-md-0 waves-effect waves-light">Get Started</a>
                    </div>
