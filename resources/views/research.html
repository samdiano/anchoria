    ...
    <body>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4 pt-5">
                    <div class="col-md-6">
                        ...
                        <p class="font-weight-light text-white text-center font-17">Information is power. Let’s help you stay informed.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <h3 class="purple-text-default gotham-bold font-weight-bold text-center">All Reports</h3>
                </div>
            </div>
        </div>
        ...
        <div class="container my-md-4">
            <div class="row mb-md-4 justify-content-center">
                <div class="col-md-3">
                    <select class="rounded-0 col-md-8 browser-default custom-select"><option>Sort by Month</option></select>
                </div>

                <div class="col-md-3">
                    <select class="rounded-0 col-md-8 browser-default custom-select"><option>Sort by Year</option></select>
                </div>

                <div class="col-md-3">
                    <select class="rounded-0 col-md-8 browser-default custom-select"><option>Sort by Report Type</option></select>
                </div>
            </div>
        </div>

        <div class="section-4-home" style="margin-top: 20%">
            <div class="container">
